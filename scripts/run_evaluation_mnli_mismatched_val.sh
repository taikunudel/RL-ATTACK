...
# export DATA_NAME='mnli_mismatched_val'
export DATA_NAME='mnli_mismatched_test'
export DATA_PATH='/usa/taikun/rl-attack/MNLI/mnli/mnli_mismatched.txt'
# export IMPORTANT_TOKENS_FILE='/usa/taikun/rl-attack/data/0dataProcessing/mnli/tokens_mnli_mismatched_val_0.json_premise.json'
# export IMPORTANT_TOKENS_FILE='/usa/taikun/rl-attack/data/0dataProcessing/mnli/tokens_mnli_mismatched_val_0.json_hypothesis.json'
export IMPORTANT_TOKENS_FILE='/usa/taikun/rl-attack/data/0dataProcessing/tokens_mnlimm_test_full.json_premise.json'
# export IMPORTANT_TOKENS_FILE='/usa/taikun/rl-attack/data/0dataProcessing/tokens_mnlimm_test_full.json_hypothesis.json'
...
export EVALUATION_JSON="/usa/taikun/rl-attack/results/2evaluation/mnli_mismatched/${ON}/${EVALUATION_PREFIX}.json"
export OUTPUT_FILE="/usa/taikun/rl-attack/results/2evaluation/mnli_mismatched/${ON}/${EVALUATION_PREFIX}.txt"
