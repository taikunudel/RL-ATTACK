...
# export IMPORTANT_TOKENS_FILE='/usa/taikun/rl-attack/data/0dataProcessing/mnli/tokens_mnli_matched_val_0.json_premise.json'
# export IMPORTANT_TOKENS_FILE='/usa/taikun/rl-attack/data/0dataProcessing/mnli/tokens_mnli_matched_val_0.json_hypothesis.json'
export IMPORTANT_TOKENS_FILE='/usa/taikun/rl-attack/data/0dataProcessing/tokens_mnlim_test_full.json_premise.json'
# export IMPORTANT_TOKENS_FILE='/usa/taikun/rl-attack/data/0dataProcessing/tokens_mnlim_test_full.json_hypothesis.json'

export ATTACKER_FILE='/usa/taikun/rl-attack/artifacts/1training/mnli/premise/02Sep/attacker_mnlimatched_0.7_2_1000_2.9903.pth'
# export ATTACKER_FILE='/usa/taikun/rl-attack/artifacts/1training/mnli/premise/02Sep/attacker_mnlimatched_0.8_2_1000_2.9205.pth'
# export ATTACKER_FILE='/usa/taikun/rl-attack/artifacts/1training/mnli/premise/02Sep/attacker_mnlimatched_0.9_2_1000_2.6550.pth'
# export ATTACKER_FILE='/usa/taikun/rl-attack/artifacts/1training/mnli/hypothesis/9Sep/attacker_mnlimatched_0.5_1_500_3.1694.pth'
...
export EVALUATION_JSON="/usa/taikun/rl-attack/results/2evaluation/mnli/${ON}/${EVALUATION_PREFIX}.json"
export OUTPUT_FILE="/usa/taikun/rl-attack/results/2evaluation/mnli/${ON}/${EVALUATION_PREFIX}.txt"
