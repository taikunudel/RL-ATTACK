...
export IMPORTANT_TOKENS_FILE='/usa/taikun/rl-attack/data/0dataProcessing/mnli/tokens_mnlimatched_0.json_premise.json'
# export IMPORTANT_TOKENS_FILE='/usa/taikun/rl-attack/data/0dataProcessing/tokens_mnlimatched_0.json_hypothesis.json'
...
export ATTACKER_PATH="/usa/taikun/rl-attack/artifacts/1training/mnli/${ON}/"
