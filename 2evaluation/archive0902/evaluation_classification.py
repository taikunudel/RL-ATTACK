...
def main(args):
    ...
    texts_, labels_ = read_corpus(path = dataPath, tokenizer = tokenizer, clean=True, MR=False, lower=False, dataName=dataName, dataPath=dataPath, tgtModel_name=tgtModel)
