...
def main():
    ...
    importantTokensFile = "/usa/taikun/rl-attack/data/0dataProcessing/tokens_qa_val.json"
    ...
    random.seed(42)
    dataset = load_from_disk("/usa/taikun/rl-attack/data/3datasets/squad_dataset")
    ...
    # attackerFile = "/usa/taikun/rl-attack/artifacts/1training/qa/attacker_squad_9_55460_0.6309.pth"
    ...
    # BERT NONLINEAR
    attackerFile = "/usa/taikun/rl-attack/artifacts/1training/qa/attacker_bertnonlinear_squad_8_49914_0.6450.pth"
