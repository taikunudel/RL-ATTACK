...
export SERVER_URL='http://infodeep:8002/v1'
export SAVE_TO_PATH='/usa/taikun/rl-attack/rl_atk/attack-genai/trained_attacker'
...
export OUTPUT_TXT="/usa/taikun/rl-attack/rl_atk/attack-genai/${TRAIN_PREFIX}.txt"
...
SCRIPT_PATH="/usa/taikun/rl-attack/rl_atk/attack-genai/train_attacker_genai.py"
